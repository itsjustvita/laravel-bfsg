...
- `tests/Live/setup.sh` installs a released version from Packagist when `BFSG_REQUIRE` is set, and the manual workflow `packagist.yml` runs the live smoke test against it in fresh Laravel 12 and 13 apps.
