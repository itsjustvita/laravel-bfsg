...
{
    /** @var list<string> */
    public const DONE = ['images', 'forms', 'headings', 'contrast', 'aria', 'links', 'keyboard', 'language', 'tables', 'media', 'semantic', 'page_title', 'input_purpose', 'focus', 'error_handling', 'status_messages'];
